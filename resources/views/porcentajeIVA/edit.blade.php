        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <strong>Editar Porcentaje de IVA</strong>
                </div>
                <div class="card-body card-block">
                    <form action="{{route('porcentajeIVA.update',$porcentajeIVA->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        {{method_field('PATCH')}}
